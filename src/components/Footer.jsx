...
export default function Footer() {
    return (
        <footer className="bg-[#000207] text-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
                    ...
                    <div className="md:col-span-1">
                        <Link to="/" className="flex items-center gap-2 mb-4">
                            ...
                            />
                            <span className="font-bold text-lg text-white">AppNest</span>
                        </Link>
                        <p className="text-gray-400 text-sm leading-relaxed mb-5">
                            Discover and install the best productivity apps trusted by
                            millions. We build tools that simplify your life every day.
                        </p>
                        {/* Social Icons */}
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><a href="#" className="hover:text-white transition">Our Apps</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><a href="#" className="hover:text-white transition">Request App</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><Link to="/apps" className="hover:text-white transition">All Apps</Link></li>
                            <li><Link to="/installation" className="hover:text-white transition">Installation</Link></li>
            ...
            <div className="border-t border-gray-800">
                <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-500">
                    <p>© Copyright by AppNest. All rights reserved.</p>
